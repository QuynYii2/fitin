    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="bg-white p-4">
                <form action="{{url("admin/post/update",$new->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mt-3">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-8">
                            <select name="type" class="form-control">
                                <option value="1" @if($new->type == 1) selected @endif>Về chúng tôi</option>
                                <option value="2" @if($new->type == 2) selected @endif>Hỗ trợ khách hàng</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-5">
