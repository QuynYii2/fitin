                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url("admin/consulting_design/update",$news->id)}}" method="post"
                                ...
                                <div class="row mb-3">
                                    <div class="col-3 d-flex align-items-center">
                                        <p class="m-0">Thể loại (<span style="color: red"> * </span>) :</p>
                                    </div>
                                    <div class="col-sm-8">
                                        <select name="type" class="form-select">
                                            <option value="1" @if($news->type == 1) selected @endif>Dự án</option>
                                            <option value="2" @if($news->type == 2) selected @endif>Cải tạo phòng</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <a href="{{route('admin.consulting_design.index')}}" class="btn btn-danger">Hủy</a>
                                    </div>
                                </div>
