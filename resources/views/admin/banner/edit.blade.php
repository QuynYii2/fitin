                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-10">
                            <select name="type" class="form-control">
                                <option value="1" @if($banner->type == 1) selected @endif>header</option>
                                <option value="2" @if($banner->type == 2) selected @endif>home top</option>
                                <option value="3" @if($banner->type == 3) selected @endif>home center</option>
                                <option value="4" @if($banner->type == 4) selected @endif>home bottom</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-2">Thứ tự hiển thị :</div>
                        <div class="col-10">
                            <input type="number" class="form-control" name="location" value="{{@$banner->location}}">
                        </div>
                    </div>
                    <div class="row mt-3">
